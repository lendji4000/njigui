            ...
            <div class="item">
                <div class="course-one__single color-1">
                    ...
                    <div class="course-one__content">
                        ...
                        <h2 class="course-one__title"><a href="/course-details">New react bootcamp</a></h2>
                        <!-- /.course-one__title -->
            ...
            <div class="item">
                <div class="course-one__single color-2">
                    ...
                    <div class="course-one__content">
                        ...
                        <h2 class="course-one__title"><a href="/course-details">Improve editing skills</a></h2>
                        <!-- /.course-one__title -->
                        <div class="course-one__stars">
                            <span class="course-one__stars-wrap">
                                <i class="fa fa-star"></i>
            ...
            <div class="item">
                <div class="course-one__single color-3">
                    ...
                    <div class="course-one__content">
                        ...
                        <h2 class="course-one__title"><a href="/course-details">Marketing strategies</a></h2>
                        <!-- /.course-one__title -->
                        <div class="course-one__stars">
                            <span class="course-one__stars-wrap">
                                <i class="fa fa-star"></i>
            ...
            <div class="item">
                <div class="course-one__single color-4">
                    ...
                    <div class="course-one__content">
                        ...
                        <h2 class="course-one__title"><a href="/course-details">Basics of photography</a></h2>
                        <!-- /.course-one__title -->
                        <div class="course-one__stars">
                            <span class="course-one__stars-wrap">
                                <i class="fa fa-star"></i>
            ...
            <div class="item">
                <div class="course-one__single color-5">
                    ...
                    <div class="course-one__content">
                        ...
                        <h2 class="course-one__title"><a href="/course-details">Affiliate bootcamp</a>
                        </h2>
                        <!-- /.course-one__title -->
                        <div class="course-one__stars">
                            <span class="course-one__stars-wrap">
            ...
            <div class="item">
                <div class="course-one__single color-6">
                    ...
                    <div class="course-one__content">
                        ...
                        <h2 class="course-one__title"><a href="/course-details">Healthy workout tips </a></h2>
                        <!-- /.course-one__title -->
                        <div class="course-one__stars">
                            <span class="course-one__stars-wrap">
                                <i class="fa fa-star"></i>
