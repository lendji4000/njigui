...
<!--            </ul>-->
            ...
            <ul class="list-group" style="margin-top: 20px">
              ...
              <li class="list-group-item active"> <a href="/offres/normes-et-standards"> <span class="fa fa-arrow-right"></span> Normes & standards</a></li>
        ...
        <div class="col-lg-8">
          <div class="faq-one__content text_justify">
            ...
            <p>Normes et Standard : ISO 9001, CMMI, SOX IT, ITIL, COBIT
              ...
              <ul>
                <li>Connaitre les principes de la norme</li>
                <li>Contribuer à la gestion du système de qualité</li>
                <li>Déployer les procédures de qualité au sein de l’organisation</li>
                <li>Organiser des réunions de suivi</li>
