...
<!--            </ul>-->
        ...
        <div class="col-lg-8">
          <div class="faq-one__content">
            ...
            <p>Pour plus d’information sur la mise en place de ces normes, veuillez contacter le cabinet Inov-Consulting à l’adresse Inov-consulting.com</p>          </div><!-- /.faq-one__content -->
        </div><!-- /.col-lg-6 -->
      </div><!-- /.row -->
    </div><!-- /.container -->
  </section>
